...
const Benja = new Person("Benja", "WebDev", "JavaScript");
console.log(Benja);
console.log(Benja.__proto__);
console.log(Benja.__proto__.__proto__);
console.log(Benja.__proto__.__proto__.__proto__);
